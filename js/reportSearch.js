...
function reportSearch() {
  ...
  xhttp.open("GET", "reportSearch.php?q="+"1"+year, true);
  xhttp.send();
  }
  ...
  xhttp.open("GET", "reportSearch.php?q="+"2"+company, true);
  xhttp.send();
  }
  ...
  xhttp.open("GET", "reportSearch.php?q="+"3"+year+company, true);
  xhttp.send();
  }
  ...
  xhttp.open("GET", "reportSearch.php?q="+"4", true);
  xhttp.send();
  }
